...
//预加载所有图片
var oImgs = {
	"block" : httppath+"block.gif",
	"wall" : httppath+"wall.png",
	"box" : httppath+"box.png",
	"ball" : httppath+"ball.png",
	"up" : httppath+"up.png",
	"down" : httppath+"down.png",
	"left" : httppath+"left.png",
	"right" : httppath+"right.png",
}
